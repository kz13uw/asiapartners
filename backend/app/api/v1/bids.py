...
══════════════════════════════════════════════════════════════
ЦИФРОВОЙ ШТАМП ПОДПИСИ ЭЦП ОРГАНИЗАТОРА (NCALayer РК):
Штамп: [ЭЛЕКТРОННЫЙ ДОКУМЕНТ ПОДПИСАН ЭЦП ОРГАНИЗАТОРА]
Хэш подписи: {eds_hash or 'SHA256: 8f9b2c...'}
Подписант: {current_user.full_name} (ИИН {current_user.iin_bin or '123456789012'})
══════════════════════════════════════════════════════════════
"""
